...
int main(int argc, char* argv[])
{
	...
	if(ftdi_usb_open(ftdi_fp, VENDOR_ID, PRODUCT_ID) != 0)
	{
		printf("open fail\n");
		ftdi_free(ftdi_fp);
		return -1;
	...
	else if(strcmp(argv[1], "readall") == 0)
	{
		...
		ftdi_eeprom_decode(peeprom, eeprom_buf, EEPROM_SIZE);
